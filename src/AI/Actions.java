...
public class Actions {
   // in any action return null if it can't be performed according to the rules
    public static Node requestFood(Node input, boolean visualize) {
        ...
        AI.Node newNode = new AI.Node(newState, input, Operator.REQUEST_FOOD, input.getDepth() + 1, input.getPathCost() + 1, 0);
        return newNode;
    }
    public static Node requestMaterials(Node input,boolean visualize) {
        ...
        AI.Node newNode = new AI.Node(newState, input, Operator.REQUEST_MATERIALS, input.getDepth() + 1, input.getPathCost() + 1, 0);
        return newNode;
    }
    public static Node requestEnergy(Node input,boolean visualize) {
        ...
        AI.Node newNode = new AI.Node(newState, input, Operator.REQUEST_ENERGY, input.getDepth() + 1, input.getPathCost() + 1, 0);
        return newNode;
    }
    public static Node wait(Node input,boolean visualize) {
        ...
        AI.Node newNode = new AI.Node(newState, input, Operator.WAIT, input.getDepth() + 1, input.getPathCost() + 1, 0);
        return newNode;
    }
    public static Node build1(Node input,boolean visualize) {
        ...
        newState.setCurrentMaterialsDelay(newState.getCurrentMaterialsDelay()-1);
        newState.setCurrentEnergyDelay(newState.getCurrentEnergyDelay()-1);
        AI.Node newNode = new AI.Node(newState, input, Operator.BUILD_1, input.getDepth() + 1, input.getPathCost() + 1, 0);
        return newNode;
    }
    public static Node build2(Node input,boolean visualize) {
        ...
        newState.setCurrentMaterialsDelay(newState.getCurrentMaterialsDelay()-1);
        newState.setCurrentEnergyDelay(newState.getCurrentEnergyDelay()-1);
        AI.Node newNode = new AI.Node(newState, input, Operator.BUILD_2, input.getDepth() + 1, input.getPathCost() + 1, 0);
        return newNode;
    }
}
